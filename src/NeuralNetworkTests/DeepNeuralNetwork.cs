...
internal class DeepNeuralNetwork
{
    private static void Main(string[] args)
    {
        ...
        ParamInitializer rangeInitializer = new RangeInitializer(-.4f, .4f);
        ...
        Matrix weights3 = neuralNetwork.GetParams()[4];
        Matrix bias3 = neuralNetwork.GetParams()[5];
